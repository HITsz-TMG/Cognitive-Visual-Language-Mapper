...
ds_collections = {
    ...
    'seedbench': {
        'test': 'data/seedbench/qwen-seed-bench_answer.jsonl'
    }
}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='/data/cxy/models/Qwen-VL/Qwen_VL')
    parser.add_argument('--dataset', type=str, default='scienceqa_test_img')
    ...
    model = QWenLMHeadModel.from_pretrained(
        args.checkpoint).eval()

    model_path = "/data/cxy/models/Qwen-VL/checkpoints/qwen_stage2_vka/checkpoint-1epoch"
