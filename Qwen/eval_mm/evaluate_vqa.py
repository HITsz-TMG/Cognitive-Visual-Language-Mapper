...
ds_collections = {
    'vqav2': {
        ...
        'test': 'data/vqav2/qwen_vqav2_mscoco_val.jsonl',
    ...
    'aokvqa_r': {
        'train': 'data/few_shot_data/aokvqa_few_shot_rationale.jsonl',
        'test': 'data/aokvqa_r/qwen_aokvqa_openended_val_rationale.jsonl',
        'max_new_tokens': 100
    },
    'aokvqa_mc': {
        'train': 'data/few_shot_data/infoseek_few_shot.json',
        'test': 'data/aokvqa/qwen_aokvqa_multichoice_val.jsonl',
        'max_new_tokens': 10
    },
    'infoseek': {
        'train': 'data/few_shot_data/infoseek_few_shot.jsonl',
        'test': 'data/infoseek/qwen_infoseek_val.jsonl',
        'max_new_tokens': 10
    },
    'okvqa': {
        'train': 'data/few_shot_data/okvqa_few_shot.jsonl',
        'test': 'data/okvqa/qwen_okvqa_mscoco_val.jsonl',
        'max_new_tokens': 10,
    },
    'textvqa': {
        'train': '',
        'test': 'data/textvqa/qwen_textvqa_val.jsonl',
        'max_new_tokens': 10,
    },
...
class VQADataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print(few_shot_prompt + self.prompt.format(image, question))
        return {
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='aokvqa_r')
    ...
    if torch.distributed.get_rank() == 0:
        ...
        results_file = f'QWen_VL_{args.dataset}_{time_prefix}_fs{args.few_shot}_s{args.seed}.json'
