...
def parse_args():
    ...
    parser.add_argument('--dir', type=str, default="./playground/knowledge_qa/eval/textvqa")
...
if __name__ == '__main__':
    ...
    src = os.path.join(args.dir, 'answers', args.split, args.ckpt, args.ckpt + '.jsonl')
    # test_split = os.path.join(args.dir, 'llava_vqav2_mscoco_test2015.jsonl')
    test_split = os.path.join(args.dir, 'llava_textvqa_val.jsonl')
