...
CKPT="CVLM-LLaVA"
STEP="1epoch"
SPLIT="llava_aokvqa_openended_val"
...
python playground/knowledge_qa/eval/aokvqa/aokvqa_openended_eval.py  --pred_file ./playground/knowledge_qa/eval/aokvqa/answers/$SPLIT/$CKPT/$STEP.jsonl