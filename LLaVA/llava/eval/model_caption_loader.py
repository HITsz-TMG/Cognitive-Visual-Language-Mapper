...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/data/cxy/Knowledge_LLaVA/checkpoints/llava_opt_pretrain_3M_continue/lmeye_params_10695.bin")
    parser.add_argument("--model-base", type=str, default="/data/share/Model/vicuna-7b-v1.5/")
    parser.add_argument("--image-folder", type=str, default="/")
    parser.add_argument("--question-file", type=str, default="/data/cxy/Knowledge_LLaVA/playground/knowledge_data/eval/wikipedia/wikipedia_test_500_v3.jsonl")
    parser.add_argument("--answers-file", type=str, default="/data/cxy/Knowledge_LLaVA/playground/knowledge_data/eval/wikipedia/answers/3M_answer_500_v3.jsonl")
